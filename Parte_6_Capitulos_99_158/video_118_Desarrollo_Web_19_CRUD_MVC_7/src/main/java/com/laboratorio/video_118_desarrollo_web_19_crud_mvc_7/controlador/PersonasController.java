...
package com.laboratorio.video_118_desarrollo_web_19_crud_mvc_7.controlador;

import com.laboratorio.video_118_desarrollo_web_19_crud_mvc_7.modelo.Persona;
import com.laboratorio.video_118_desarrollo_web_19_crud_mvc_7.modelo.PersonaDB;
import com.laboratorio.video_118_desarrollo_web_19_crud_mvc_7.modelo.PersonaRequest;
import com.laboratorio.video_118_desarrollo_web_19_crud_mvc_7.persistencia.ConnectionPoolManager;
...
public class PersonasController extends HttpServlet {
        ...
        switch(accion){
            ...
            case "guardar":
                ...
                if(resultado.isEmpty()){
                    ...
                    if(guardarPersona(request)){
                        mensaje="Se ha guardado los datos de la persona correctamente.";
                    }else{
            ...
            case "editar":
                if(!editarPersona(request,response)){
                    mensaje = "Se ha presentado un error al recuperar los datos de la persona.";
                    listarPersonas(mensaje,request,response);
                }
                break;
            case "eliminar":
                if(eliminarPersona(request)){
                    mensaje = "Se ha eliminado los datos de la persona correctamente";
                }else{
                    mensaje="Se ha presentado un error al guardar los datos de la persona.";
                }
                listarPersonas(mensaje,request,response);
    ...
    private boolean guardarPersona(HttpServletRequest request){
        ...
        if(codigo==0){
            ...
            try{                
                return personaDB.editar(codigo,nombre,apellidos,fechaNac,experiencia);
    ...
    private boolean eliminarPersona(HttpServletRequest request){
        ...
        try{
            ...
            log.log(Level.SEVERE,"Error eliminando los datos de la persona");
            return false;
        }
    }
