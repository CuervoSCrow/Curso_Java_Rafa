...
public class Dado extends JPanel{
    ...
    public void lanzar(){
        Random valorDado;
//        Inicializar el objeeto de numeros aleatorios
        valorDado = new Random();
//        Generar el valor del dado y actualizar la interfaz
        numero = valorDado.nextInt(6)+1;
        updateUI();
    }
    public void paintComponent(Graphics g){
        String str;
//        Crear Rectangulo blanco
        g.setColor(Color.white);
        g.fillRoundRect(5,5,120,120,5,5);

//        Crear un rectangulo negro con el borde negro y contenido blanco
